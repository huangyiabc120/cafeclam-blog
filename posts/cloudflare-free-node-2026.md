...
2. **一个免费域名**（推荐 eu.org、cloudflare.pages.dev 等免费后缀）
   
3. **生成 UUID**（用于节点配置的唯一标识）
...
### 方案一：纯小白面板派（Pages 拖拽部署）⭐ 推荐入门

不想碰代码？这一方案最适合你。

- **源码**：基于 cmliu 大佬的 edgetunnel 改进版
...
如果节点经常被墙或恶意扫描，这一方案可以长期稳定使用。

- **源码**：基于 Joey 持续维护的 cfnew 项目
...
不想去传统的 Workers 和 Pages 里挤？这一方案另辟蹊径。

- **源码**：https://github.com/amclubs/am-cf-tunnel
...
- **源码**：https://github.com/yonggekkk/Cloudflare-vless-trojan
...
### macOS / iOS
推荐使用 Shadowrocket、Stash 等支持 VLESS 协议的客户端
...
- https://xuemusi.com/2025/05/25/Cloudflare-vless/
- https://mliaomcx.com/
