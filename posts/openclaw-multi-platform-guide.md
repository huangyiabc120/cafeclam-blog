...
回到飞书开放平台，点击「版本管理与发布」→「创建版本」→「申请发布」。企业内部应用通常秒过审核。
...
架构：QQ App ←→ NapCat (OneBot v11) ←WebSocket→ OpenClaw QQ 插件

### 步骤 1：安装 NapCat（Docker 方式）
...
如果你觉得手动编辑 JSON 太麻烦，可以让 AI 帮你配置。告诉它你的 Token 和配置，它会自动帮你完成所有配置并重启 Gateway。
...
- OpenClaw 官方文档：https://clawd.org.cn/start/getting-started.html
- OpenClaw GitHub：https://github.com/openclaw/openclaw
- OpenClaw 中文社区：https://clawd.org.cn

## 参考来源

- OpenClaw 多平台机器人配置完全教程：https://openclaw.lz.wiki/posts/2026-03-02-openclaw-multi-bot-setup/
- OpenClaw 中文社区入门指南：https://clawd.org.cn/start/getting-started.html
